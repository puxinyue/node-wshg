...
const UUID = process.env.UUID || 'be9bab0c-fc5f-4c25-a8f5-21958c36640a'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';       // 哪吒v1填写形式：nz.abc.com:8008   哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';           // 哪吒v1没有此变量，v0的agent端口为{443,8443,2096,2087,2083,2053}其中之一时开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || '';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
const DOMAIN = process.env.DOMAIN || 'nyc9527.sunnyueec.dpdns.org';       // 填写项目域名或已反代的域名，不带前缀，建议填已反代的域名
const AUTO_ACCESS = process.env.AUTO_ACCESS || 'eyJhIjoiNzU4YWQxOTdjN2Y1NmM5NGQzMWZkYTg1NzlkMWE2ZjMiLCJ0IjoiODAyMzE5M2QtODllMS00YjllLWJlNGItNjljMjNjOTU5ZDNlIiwicyI6IlpHTXdOemN5WlRZdFlqUmtZeTAwTldOaExUazFPRFV0WVdRM1pHUm1NRGxpWkdZNCJ9';      // 是否开启自动访问保活,false为关闭,true为开启,需同时填写DOMAIN变量
